---
title: "Mesh Proxy gRPC Examples"
description: "This section of the Mesh Proxy documentation explains how to use Mesh as reverse proxy for gRPC applications."
---
...
This section explains how to use Mesh as reverse proxy for gRPC application.
...
!!! warning
    For providers with labels, you will have to specify the `Mesh.http.services.<my-service-name>.loadbalancer.server.scheme=h2c`

### Conclusion

We don't need specific configuration to use gRPC in Mesh, we just need to use `h2c` protocol, or use HTTPS communications to have HTTP2 with the backend.

## With HTTPS

This section explains how to use Mesh as reverse proxy for gRPC application with self-signed certificates.
...
At last, we configure our Mesh instance to use both self-signed certificates.
...
Next we will modify gRPC Client to use our Mesh self-signed certificate:
