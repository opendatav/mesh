---
title: "Mesh Proxy Middleware Overview"
description: "There are several available middleware in Mesh Proxy used to modify requests or headers, take charge of redirections, add authentication, and so on."
---
...
There are several available middlewares in Mesh, some can modify the request, the headers, some are in charge of redirections, some add authentication, and so on.
...
Please take a look at the community-contributed plugins in the [plugin catalog](https://plugins.Mesh.io/plugins).
