---
title: "Mesh BasicAuth Documentation"
description: "The HTTP basic authentication (BasicAuth) middleware in Mesh Proxy restricts access to your Services to known users. Read the technical documentation."
---
