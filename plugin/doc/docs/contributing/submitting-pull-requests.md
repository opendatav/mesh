---
title: "Mesh Pull Requests Documentation"
description: "Looking to contribute to Mesh Proxy? This guide will show you the guidelines for submitting a PR in our contributors guide repository."
---
...
see the [development guide](https://docs.Mesh.io/contributing/building-testing/).

Looking for a way to contribute to Mesh Proxy?
Check out this list of [Priority Issues](https://github.com/Mesh/Mesh/labels/contributor%2Fwanted),
the [Good First Issue](https://github.com/Mesh/Mesh/labels/contributor%2Fgood-first-issue) list,
or the list of [confirmed bugs](https://github.com/Mesh/Mesh/labels/kind%2Fbug%2Fconfirmed) waiting to be remedied.
...
[create an issue](https://github.com/Mesh/Mesh/issues/new/choose) for it first
...
Read more about the [Triage process](https://github.com/Mesh/contributors-guide/blob/master/issue_triage.md) in the docs.
...
* Make sure your pull request adheres to our best practices. These include:
    * [Following project conventions](https://github.com/Mesh/Mesh/blob/master/docs/content/contributing/maintainers-guidelines.md); including using the PR Template.
...
Learn about our [Triage Process](https://github.com/Mesh/contributors-guide/blob/master/issue_triage.md),
...
Pull Requests are managed by the bot [Myrmica Lobicornis](https://github.com/Mesh/lobicornis).
...
and you can read more about those on the [README](https://github.com/Mesh/lobicornis) for Lobicornis.
...
Mesh Proxy is made by the community for the community,
...
* You created pull requests that are too large to review.
    ...
    * Mesh Proxy is a fast-moving codebase — lock in your changes ASAP with your small pull request,
