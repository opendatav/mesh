...
description: "Mesh supports several metrics backends, including OpenTelemetry. Learn how to implement it for observability in Mesh Proxy. Read the technical documentation."
---
