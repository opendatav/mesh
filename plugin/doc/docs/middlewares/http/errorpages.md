...
!!! important
    ...
    The error page itself is _not_ hosted by Mesh.
...
labels:
  ...
  - "Mesh.http.middlewares.test-errors.errors.service=serviceError"
...
!!! note ""
    ...
    In Kubernetes, you need to reference a Kubernetes Service instead of a Mesh service.
