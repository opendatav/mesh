...
There are several available middleware in Mesh, some can modify the request, the headers, some are in charge of redirections, some add authentication, and so on.
