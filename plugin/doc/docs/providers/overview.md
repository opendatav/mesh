---
title: "Mesh Configuration Discovery Overview"
description: "Configuration discovery in Mesh is achieved through Providers. The providers are infrastructure components. Read the documentation to learn more."
---
...
Configuration discovery in Mesh is achieved through _Providers_.
...
When you declare certain objects in the Mesh dynamic configuration,
...
!!! important "Kubernetes Namespace"
    ...
    In this case, since the definition of a Mesh dynamic configuration object is not in Kubernetes,
...
!!! abstract "Referencing a Mesh Dynamic Configuration Object from Another Provider"
...
Below is the list of the currently supported providers in Mesh.
...
!!! info "More Providers"
    ...
    The current version of Mesh does not yet support every provider that Mesh v2.11 did.
    See the [previous version (v2.11)](https://doc.Mesh.io/Mesh/v2.11/) for more information.
...
By default, Mesh creates routes for all detected containers.

If you want to limit the scope of the Mesh service discovery,
...
### `exposedByDefault` and `Mesh.enable`
