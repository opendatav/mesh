---
title: "Mesh ZooKeeper Documentation"
description: "For configuration discovery in Mesh Proxy, you can store your configurations in ZooKeeper. Read the technical documentation."
---
...
Store your configuration in ZooKeeper and let Mesh do the rest!
...
```bash tab="CLI"
--providers.zookeeper.rootkey=Mesh
```
