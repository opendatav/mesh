...
import {Codec, context, Mesh, MeshService, ServiceLoader, Versions} from '@ducesoft/mesh';
...
export function TerminalHub() {
    ...
    const onCommandInput = (command: string): void => {
        switch (command) {
            ...
            default:
                ...
                MeshService.endpoint.fuzzy(codec.encode(command), ctx).then(v => {
    ...
    useEffect(() => {
        ...
        MeshService.network.version('').then(v => {
            initTerm(element, v);
