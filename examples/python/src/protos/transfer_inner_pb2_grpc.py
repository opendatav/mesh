...
import protos.transfer_inner_pb2 as transfer__inner__pb2
...
class PrivateTransferTransportStub(object):
    ...
    def __init__(self, channel):
        ...
        self.peek = channel.unary_unary(
                ...
                request_serializer=transfer__inner__pb2.PeekInbound.SerializeToString,
                response_deserializer=transfer__inner__pb2.TransportOutbound.FromString,
                )
        self.pop = channel.unary_unary(
                '/org.ppc.ptp.PrivateTransferTransport/pop',
                request_serializer=transfer__inner__pb2.PopInbound.SerializeToString,
                response_deserializer=transfer__inner__pb2.TransportOutbound.FromString,
                )
        self.push = channel.unary_unary(
                '/org.ppc.ptp.PrivateTransferTransport/push',
                request_serializer=transfer__inner__pb2.PushInbound.SerializeToString,
                response_deserializer=transfer__inner__pb2.TransportOutbound.FromString,
                )
        self.release = channel.unary_unary(
                '/org.ppc.ptp.PrivateTransferTransport/release',
                request_serializer=transfer__inner__pb2.ReleaseInbound.SerializeToString,
                response_deserializer=transfer__inner__pb2.TransportOutbound.FromString,
                )
...
def add_PrivateTransferTransportServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'peek': grpc.unary_unary_rpc_method_handler(
                    servicer.peek,
                    request_deserializer=transfer__inner__pb2.PeekInbound.FromString,
                    response_serializer=transfer__inner__pb2.TransportOutbound.SerializeToString,
            ),
            'pop': grpc.unary_unary_rpc_method_handler(
                    servicer.pop,
                    request_deserializer=transfer__inner__pb2.PopInbound.FromString,
                    response_serializer=transfer__inner__pb2.TransportOutbound.SerializeToString,
            ),
            'push': grpc.unary_unary_rpc_method_handler(
                    servicer.push,
                    request_deserializer=transfer__inner__pb2.PushInbound.FromString,
                    response_serializer=transfer__inner__pb2.TransportOutbound.SerializeToString,
            ),
            'release': grpc.unary_unary_rpc_method_handler(
                    servicer.release,
                    request_deserializer=transfer__inner__pb2.ReleaseInbound.FromString,
                    response_serializer=transfer__inner__pb2.TransportOutbound.SerializeToString,
            ),
    }
...
class PrivateTransferTransport(object):
    ...
    def peek(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.ppc.ptp.PrivateTransferTransport/peek',
            transfer__inner__pb2.PeekInbound.SerializeToString,
            transfer__inner__pb2.TransportOutbound.FromString,
    ...
    def pop(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.ppc.ptp.PrivateTransferTransport/pop',
            transfer__inner__pb2.PopInbound.SerializeToString,
            transfer__inner__pb2.TransportOutbound.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def push(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.ppc.ptp.PrivateTransferTransport/push',
            transfer__inner__pb2.PushInbound.SerializeToString,
            transfer__inner__pb2.TransportOutbound.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def release(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.ppc.ptp.PrivateTransferTransport/release',
            transfer__inner__pb2.ReleaseInbound.SerializeToString,
            transfer__inner__pb2.TransportOutbound.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
