...
import protos.transfer_outer_pb2 as transfer__outer__pb2
...
class PrivateTransferProtocolStub(object):
    ...
    def __init__(self, channel):
        ...
        self.transport = channel.stream_stream(
                ...
                request_serializer=transfer__outer__pb2.Inbound.SerializeToString,
                response_deserializer=transfer__outer__pb2.Outbound.FromString,
                )
...
def add_PrivateTransferProtocolServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'transport': grpc.stream_stream_rpc_method_handler(
                    servicer.transport,
                    request_deserializer=transfer__outer__pb2.Inbound.FromString,
                    response_serializer=transfer__outer__pb2.Outbound.SerializeToString,
            ),
...
class PrivateTransferProtocol(object):
    ...
    def transport(request_iterator,
        ...
        return grpc.experimental.stream_stream(request_iterator, target, '/org.ppc.ptp.PrivateTransferProtocol/transport',
            transfer__outer__pb2.Inbound.SerializeToString,
            transfer__outer__pb2.Outbound.FromString,
